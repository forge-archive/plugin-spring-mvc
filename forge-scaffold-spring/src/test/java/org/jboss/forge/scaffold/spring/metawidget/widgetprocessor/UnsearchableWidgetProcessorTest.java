         ...
         extends TestCase
{
   ...
   {
      StaticXmlMetawidget metawidget = new StaticSpringMetawidget();
      ...
      assertTrue(widgetProcessor.processWidget(new FormInputTag(), PROPERTY, attributes, metawidget) != null);

      attributes.put(TYPE, int.class.getName());
      assertTrue(widgetProcessor.processWidget(new FormInputTag(), PROPERTY, attributes, metawidget) != null);

      attributes.put(TYPE, "com.test.domain.Foo");
      attributes.put(SPRING_LOOKUP, String.class.getName());
      assertTrue(widgetProcessor.processWidget(new FormInputTag(), PROPERTY, attributes, metawidget) != null);
   }
   ...
   public void testSuppressTooMany()
   {
      ...
      StaticMetawidget metawidget = new StaticSpringMetawidget();
      UnsearchableWidgetProcessor widgetProcessor = new UnsearchableWidgetProcessor();
      widgetProcessor.onStartBuild(metawidget);
