...
package org.jboss.forge.scaffold.spring.metawidget.inspector.propertystyle;
...
import org.jboss.forge.scaffold.spring.metawidget.inspector.propertystyle.MockAnnotationComplex.anEnum;
         ...
         extends AbstractShellTest
{
            ...
            throws Exception
   {
      ...
      ScaffoldUtil
               .createOrOverwrite(
                        null,
                        java.getJavaResource("org/jboss/forge/scaffold/spring/metawidget/inspector/propertystyle/MockAnnotatedClass.java"),
                        getClass()
                                 .getResourceAsStream(
                                          "/org/jboss/forge/scaffold/spring/metawidget/inspector/propertystyle/MockAnnotatedClass.java"),
                        true);
      ...
      Map<String, Property> properties = propertyStyle
               .getProperties("org.jboss.forge.scaffold.spring.metawidget.inspector.propertystyle.MockAnnotatedClass");
